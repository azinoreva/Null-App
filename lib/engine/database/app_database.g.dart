...
class $IdentityTable extends Identity
  ...
  static const VerificationMeta _saltVersionMeta = const VerificationMeta(
    'saltVersion',
  );
  @override
  late final GeneratedColumn<int> saltVersion = GeneratedColumn<int>(
    'salt_version',
    aliasedName,
    false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('salt_version')) {
      context.handle(
        _saltVersionMeta,
        saltVersion.isAcceptableOrUnknown(
          data['salt_version']!,
          _saltVersionMeta,
        ),
      );
  ...
  IdentityData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return IdentityData(
      ...
      saltVersion: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}salt_version'],
      )!,
...
class IdentityData extends DataClass implements Insertable<IdentityData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['salt_version'] = Variable<int>(saltVersion);
  ...
  factory IdentityData.fromJson(
    ...
    return IdentityData(
      ...
      saltVersion: serializer.fromJson<int>(json['saltVersion']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'saltVersion': serializer.toJson<int>(saltVersion),
  ...
  IdentityData copyWithCompanion(IdentityCompanion data) {
    return IdentityData(
      ...
      phoneNumber: data.phoneNumber.present
          ...
          : this.phoneNumber,
      saltVersion: data.saltVersion.present
          ? data.saltVersion.value
          : this.saltVersion,
  ...
  bool operator ==(Object other) =>
      ...
      (other is IdentityData &&
          ...
          other.saltVersion == this.saltVersion &&
...
class IdentityCompanion extends UpdateCompanion<IdentityData> {
  ...
  const IdentityCompanion({
    ...
    this.saltVersion = const Value.absent(),
  ...
  static Insertable<IdentityData> custom({
    ...
    return RawValuesInsertable({
      ...
      if (saltVersion != null) 'salt_version': saltVersion,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (saltVersion.present) {
      map['salt_version'] = Variable<int>(saltVersion.value);
    }
...
class $ServersTable extends Servers with TableInfo<$ServersTable, Server> {
  ...
  late final GeneratedColumn<int> colour = GeneratedColumn<int>(
    ...
    type: DriftSqlType.int,
    requiredDuringInsert: false,
    defaultValue: const Constant(65280),
  );
  @override
  List<GeneratedColumn> get $columns => [
    serverId,
...
class $MessagesTable extends Messages with TableInfo<$MessagesTable, Message> {
  ...
  static const VerificationMeta _decryptedMessageMeta = const VerificationMeta(
    'decryptedMessage',
  );
  @override
  late final GeneratedColumn<String> decryptedMessage = GeneratedColumn<String>(
    'decrypted_message',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('decrypted_message')) {
      context.handle(
        _decryptedMessageMeta,
        decryptedMessage.isAcceptableOrUnknown(
  ...
  Message map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Message(
      ...
      decryptedMessage: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}decrypted_message'],
      ),
...
class Message extends DataClass implements Insertable<Message> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || decryptedMessage != null) {
      map['decrypted_message'] = Variable<String>(decryptedMessage);
    }
  ...
  MessagesCompanion toCompanion(bool nullToAbsent) {
    return MessagesCompanion(
      ...
      nonce: Value(nonce),
      decryptedMessage: decryptedMessage == null && nullToAbsent
          ? const Value.absent()
  ...
  factory Message.fromJson(
    ...
    return Message(
      ...
      decryptedMessage: serializer.fromJson<String?>(json['decryptedMessage']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'decryptedMessage': serializer.toJson<String?>(decryptedMessage),
  ...
  Message copyWith({
    ...
    Uint8List? nonce,
    Value<String?> decryptedMessage = const Value.absent(),
    int? messageType,
    int? status,
    Uint8List? mac,
    int? keyVersion,
    ...
    decryptedMessage: decryptedMessage.present
  ...
  Message copyWithCompanion(MessagesCompanion data) {
    return Message(
      ...
      decryptedMessage: data.decryptedMessage.present
          ? data.decryptedMessage.value
          : this.decryptedMessage,
  ...
  String toString() {
    return (StringBuffer('Message(')
          ...
          ..write('nonce: $nonce, ')
          ..write('decryptedMessage: $decryptedMessage, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Message &&
          ...
          other.decryptedMessage == this.decryptedMessage &&
...
class MessagesCompanion extends UpdateCompanion<Message> {
  ...
  final Value<String?> decryptedMessage;
  ...
  const MessagesCompanion({
    ...
    this.decryptedMessage = const Value.absent(),
  ...
  static Insertable<Message> custom({
    ...
    Expression<String>? decryptedMessage,
    ...
    return RawValuesInsertable({
      ...
      if (decryptedMessage != null) 'decrypted_message': decryptedMessage,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (decryptedMessage.present) {
      map['decrypted_message'] = Variable<String>(decryptedMessage.value);
    }
...
class $GroupsTable extends Groups with TableInfo<$GroupsTable, Group> {
  ...
  static const VerificationMeta _newPrivateKeyMeta = const VerificationMeta(
    'newPrivateKey',
  );
  @override
  late final GeneratedColumn<String> newPrivateKey = GeneratedColumn<String>(
    'new_private_key',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  static const VerificationMeta _swapTimeMeta = const VerificationMeta(
    'swapTime',
  );
  @override
  late final GeneratedColumn<int> swapTime = GeneratedColumn<int>(
    'swap_time',
    aliasedName,
    true,
    type: DriftSqlType.int,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('new_private_key')) {
      context.handle(
        _newPrivateKeyMeta,
        newPrivateKey.isAcceptableOrUnknown(
          data['new_private_key']!,
          _newPrivateKeyMeta,
        ),
      );
    }
    if (data.containsKey('swap_time')) {
      context.handle(
        _swapTimeMeta,
        swapTime.isAcceptableOrUnknown(data['swap_time']!, _swapTimeMeta),
      );
    }
  ...
  Group map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Group(
      ...
      newPrivateKey: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}new_private_key'],
      ),
      swapTime: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}swap_time'],
      ),
...
class Group extends DataClass implements Insertable<Group> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || newPrivateKey != null) {
      map['new_private_key'] = Variable<String>(newPrivateKey);
    }
    if (!nullToAbsent || swapTime != null) {
      map['swap_time'] = Variable<int>(swapTime);
    }
  ...
  GroupsCompanion toCompanion(bool nullToAbsent) {
    return GroupsCompanion(
      ...
      privateKey: privateKey == null && nullToAbsent
          ? const Value.absent()
          : Value(privateKey),
      newPrivateKey: newPrivateKey == null && nullToAbsent
          ? const Value.absent()
          : Value(newPrivateKey),
      swapTime: swapTime == null && nullToAbsent
          ? const Value.absent()
          : Value(swapTime),
  ...
  factory Group.fromJson(
    ...
    return Group(
      ...
      newPrivateKey: serializer.fromJson<String?>(json['newPrivateKey']),
      swapTime: serializer.fromJson<int?>(json['swapTime']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'newPrivateKey': serializer.toJson<String?>(newPrivateKey),
      'swapTime': serializer.toJson<int?>(swapTime),
  ...
  Group copyWith({
    ...
    Value<String?> newPrivateKey = const Value.absent(),
    Value<int?> swapTime = const Value.absent(),
    ...
    newPrivateKey: newPrivateKey.present
        ? newPrivateKey.value
        : this.newPrivateKey,
    swapTime: swapTime.present ? swapTime.value : this.swapTime,
  ...
  Group copyWithCompanion(GroupsCompanion data) {
    return Group(
      ...
      privateKey: data.privateKey.present
          ...
          : this.privateKey,
      newPrivateKey: data.newPrivateKey.present
          ? data.newPrivateKey.value
          : this.newPrivateKey,
      swapTime: data.swapTime.present ? data.swapTime.value : this.swapTime,
  ...
  String toString() {
    return (StringBuffer('Group(')
          ...
          ..write('newPrivateKey: $newPrivateKey, ')
          ..write('swapTime: $swapTime, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Group &&
          ...
          other.newPrivateKey == this.newPrivateKey &&
          other.swapTime == this.swapTime &&
...
class GroupsCompanion extends UpdateCompanion<Group> {
  ...
  final Value<String?> newPrivateKey;
  final Value<int?> swapTime;
  ...
  const GroupsCompanion({
    ...
    this.newPrivateKey = const Value.absent(),
    this.swapTime = const Value.absent(),
  ...
  static Insertable<Group> custom({
    ...
    Expression<String>? newPrivateKey,
    Expression<int>? swapTime,
    ...
    return RawValuesInsertable({
      ...
      if (newPrivateKey != null) 'new_private_key': newPrivateKey,
      if (swapTime != null) 'swap_time': swapTime,
  ...
  GroupsCompanion copyWith({
    ...
    return GroupsCompanion(
      ...
      newPrivateKey: newPrivateKey ?? this.newPrivateKey,
      swapTime: swapTime ?? this.swapTime,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (newPrivateKey.present) {
      map['new_private_key'] = Variable<String>(newPrivateKey.value);
    }
    if (swapTime.present) {
      map['swap_time'] = Variable<int>(swapTime.value);
    }
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  @override
  late final GeneratedColumn<Uint8List> blobparam1 = GeneratedColumn<Uint8List>(
    'blobparam1',
    aliasedName,
    true,
    type: DriftSqlType.blob,
  ...
  static const VerificationMeta _blobparam2Meta = const VerificationMeta(
    'blobparam2',
  );
  @override
  late final GeneratedColumn<Uint8List> blobparam2 = GeneratedColumn<Uint8List>(
    'blobparam2',
    aliasedName,
    true,
    type: DriftSqlType.blob,
  ...
  static const VerificationMeta _blobparam3Meta = const VerificationMeta(
    'blobparam3',
  );
  @override
  late final GeneratedColumn<Uint8List> blobparam3 = GeneratedColumn<Uint8List>(
    'blobparam3',
    aliasedName,
    true,
    type: DriftSqlType.blob,
  ...
  static const VerificationMeta _blobparam4Meta = const VerificationMeta(
    'blobparam4',
  );
  @override
  late final GeneratedColumn<Uint8List> blobparam4 = GeneratedColumn<Uint8List>(
    'blobparam4',
    aliasedName,
    true,
    type: DriftSqlType.blob,
  ...
  static const VerificationMeta _blobparam5Meta = const VerificationMeta(
    'blobparam5',
  );
  @override
  late final GeneratedColumn<Uint8List> blobparam5 = GeneratedColumn<Uint8List>(
    'blobparam5',
    aliasedName,
    true,
    type: DriftSqlType.blob,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('blobparam1')) {
      context.handle(
        _blobparam1Meta,
        blobparam1.isAcceptableOrUnknown(data['blobparam1']!, _blobparam1Meta),
      );
    }
    if (data.containsKey('blobparam2')) {
      context.handle(
        _blobparam2Meta,
        blobparam2.isAcceptableOrUnknown(data['blobparam2']!, _blobparam2Meta),
      );
    }
    if (data.containsKey('blobparam3')) {
      context.handle(
        _blobparam3Meta,
        blobparam3.isAcceptableOrUnknown(data['blobparam3']!, _blobparam3Meta),
      );
    }
    if (data.containsKey('blobparam4')) {
      context.handle(
        _blobparam4Meta,
        blobparam4.isAcceptableOrUnknown(data['blobparam4']!, _blobparam4Meta),
      );
    }
    if (data.containsKey('blobparam5')) {
      context.handle(
        _blobparam5Meta,
        blobparam5.isAcceptableOrUnknown(data['blobparam5']!, _blobparam5Meta),
      );
    }
    if (data.containsKey('created_at')) {
      context.handle(
  ...
  Task map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Task(
      ...
      blobparam1: attachedDatabase.typeMapping.read(
        DriftSqlType.blob,
        data['${effectivePrefix}blobparam1'],
      ),
      blobparam2: attachedDatabase.typeMapping.read(
        DriftSqlType.blob,
        data['${effectivePrefix}blobparam2'],
      ),
      blobparam3: attachedDatabase.typeMapping.read(
        DriftSqlType.blob,
        data['${effectivePrefix}blobparam3'],
      ),
      blobparam4: attachedDatabase.typeMapping.read(
        DriftSqlType.blob,
        data['${effectivePrefix}blobparam4'],
      ),
      blobparam5: attachedDatabase.typeMapping.read(
        DriftSqlType.blob,
        data['${effectivePrefix}blobparam5'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}created_at'],
...
class Task extends DataClass implements Insertable<Task> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || blobparam1 != null) {
      map['blobparam1'] = Variable<Uint8List>(blobparam1);
    }
    if (!nullToAbsent || blobparam2 != null) {
      map['blobparam2'] = Variable<Uint8List>(blobparam2);
    }
    if (!nullToAbsent || blobparam3 != null) {
      map['blobparam3'] = Variable<Uint8List>(blobparam3);
    }
    if (!nullToAbsent || blobparam4 != null) {
      map['blobparam4'] = Variable<Uint8List>(blobparam4);
    }
    if (!nullToAbsent || blobparam5 != null) {
      map['blobparam5'] = Variable<Uint8List>(blobparam5);
    }
    map['created_at'] = Variable<int>(createdAt);
    map['updated_at'] = Variable<int>(updatedAt);
  ...
  TasksCompanion toCompanion(bool nullToAbsent) {
    return TasksCompanion(
      ...
      blobparam1: blobparam1 == null && nullToAbsent
          ? const Value.absent()
          : Value(blobparam1),
      blobparam2: blobparam2 == null && nullToAbsent
          ? const Value.absent()
          : Value(blobparam2),
      blobparam3: blobparam3 == null && nullToAbsent
          ? const Value.absent()
          : Value(blobparam3),
      blobparam4: blobparam4 == null && nullToAbsent
          ? const Value.absent()
          : Value(blobparam4),
      blobparam5: blobparam5 == null && nullToAbsent
          ? const Value.absent()
          : Value(blobparam5),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
  ...
  factory Task.fromJson(
    ...
    return Task(
      ...
      blobparam1: serializer.fromJson<Uint8List?>(json['blobparam1']),
      blobparam2: serializer.fromJson<Uint8List?>(json['blobparam2']),
      blobparam3: serializer.fromJson<Uint8List?>(json['blobparam3']),
      blobparam4: serializer.fromJson<Uint8List?>(json['blobparam4']),
      blobparam5: serializer.fromJson<Uint8List?>(json['blobparam5']),
      createdAt: serializer.fromJson<int>(json['createdAt']),
      updatedAt: serializer.fromJson<int>(json['updatedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'blobparam1': serializer.toJson<Uint8List?>(blobparam1),
      'blobparam2': serializer.toJson<Uint8List?>(blobparam2),
      'blobparam3': serializer.toJson<Uint8List?>(blobparam3),
      'blobparam4': serializer.toJson<Uint8List?>(blobparam4),
      'blobparam5': serializer.toJson<Uint8List?>(blobparam5),
      'createdAt': serializer.toJson<int>(createdAt),
      'updatedAt': serializer.toJson<int>(updatedAt),
  ...
  Task copyWith({
    ...
    Value<Uint8List?> blobparam4 = const Value.absent(),
    Value<Uint8List?> blobparam5 = const Value.absent(),
    int? createdAt,
    int? updatedAt,
    int? retryCount,
    ...
    blobparam1: blobparam1.present ? blobparam1.value : this.blobparam1,
    blobparam2: blobparam2.present ? blobparam2.value : this.blobparam2,
    blobparam3: blobparam3.present ? blobparam3.value : this.blobparam3,
    blobparam4: blobparam4.present ? blobparam4.value : this.blobparam4,
    blobparam5: blobparam5.present ? blobparam5.value : this.blobparam5,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
  ...
  Task copyWithCompanion(TasksCompanion data) {
    return Task(
      ...
      functionArgs: data.functionArgs.present
          ...
          : this.functionArgs,
      blobparam1: data.blobparam1.present
          ? data.blobparam1.value
          : this.blobparam1,
      blobparam2: data.blobparam2.present
          ? data.blobparam2.value
          : this.blobparam2,
      blobparam3: data.blobparam3.present
          ? data.blobparam3.value
          : this.blobparam3,
      blobparam4: data.blobparam4.present
          ? data.blobparam4.value
          : this.blobparam4,
      blobparam5: data.blobparam5.present
          ? data.blobparam5.value
          : this.blobparam5,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  String toString() {
    return (StringBuffer('Task(')
          ...
          ..write('blobparam1: $blobparam1, ')
          ..write('blobparam2: $blobparam2, ')
          ..write('blobparam3: $blobparam3, ')
          ..write('blobparam4: $blobparam4, ')
          ..write('blobparam5: $blobparam5, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
  ...
  int get hashCode => Object.hashAll([
    ...
    functionName,
    functionArgs,
    $driftBlobEquality.hash(blobparam1),
    $driftBlobEquality.hash(blobparam2),
    $driftBlobEquality.hash(blobparam3),
    $driftBlobEquality.hash(blobparam4),
    $driftBlobEquality.hash(blobparam5),
    createdAt,
    updatedAt,
    retryCount,
    nextRetryAt,
  ...
  bool operator ==(Object other) =>
      ...
      (other is Task &&
          ...
          $driftBlobEquality.equals(other.blobparam1, this.blobparam1) &&
          $driftBlobEquality.equals(other.blobparam2, this.blobparam2) &&
          $driftBlobEquality.equals(other.blobparam3, this.blobparam3) &&
          $driftBlobEquality.equals(other.blobparam4, this.blobparam4) &&
          $driftBlobEquality.equals(other.blobparam5, this.blobparam5) &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt &&
...
class TasksCompanion extends UpdateCompanion<Task> {
  ...
  final Value<Uint8List?> blobparam1;
  final Value<Uint8List?> blobparam2;
  final Value<Uint8List?> blobparam3;
  final Value<Uint8List?> blobparam4;
  final Value<Uint8List?> blobparam5;
  final Value<int> createdAt;
  final Value<int> updatedAt;
  ...
  const TasksCompanion({
    ...
    this.blobparam4 = const Value.absent(),
    this.blobparam5 = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
  ...
  static Insertable<Task> custom({
    ...
    Expression<Uint8List>? blobparam1,
    Expression<Uint8List>? blobparam2,
    Expression<Uint8List>? blobparam3,
    Expression<Uint8List>? blobparam4,
    Expression<Uint8List>? blobparam5,
    Expression<int>? createdAt,
    Expression<int>? updatedAt,
    ...
    return RawValuesInsertable({
      ...
      if (blobparam1 != null) 'blobparam1': blobparam1,
      if (blobparam2 != null) 'blobparam2': blobparam2,
      if (blobparam3 != null) 'blobparam3': blobparam3,
      if (blobparam4 != null) 'blobparam4': blobparam4,
      if (blobparam5 != null) 'blobparam5': blobparam5,
      if (createdAt != null) 'created_at': createdAt,
      if (updatedAt != null) 'updated_at': updatedAt,
  ...
  TasksCompanion copyWith({
    ...
    Value<Uint8List?>? blobparam4,
    Value<Uint8List?>? blobparam5,
    Value<int>? createdAt,
    Value<int>? updatedAt,
    ...
    return TasksCompanion(
      ...
      functionName: functionName ?? this.functionName,
      functionArgs: functionArgs ?? this.functionArgs,
      blobparam1: blobparam1 ?? this.blobparam1,
      blobparam2: blobparam2 ?? this.blobparam2,
      blobparam3: blobparam3 ?? this.blobparam3,
      blobparam4: blobparam4 ?? this.blobparam4,
      blobparam5: blobparam5 ?? this.blobparam5,
      createdAt: createdAt ?? this.createdAt,
      updatedAt: updatedAt ?? this.updatedAt,
      retryCount: retryCount ?? this.retryCount,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (blobparam1.present) {
      map['blobparam1'] = Variable<Uint8List>(blobparam1.value);
    }
    if (blobparam2.present) {
      map['blobparam2'] = Variable<Uint8List>(blobparam2.value);
    }
    if (blobparam3.present) {
      map['blobparam3'] = Variable<Uint8List>(blobparam3.value);
    }
    if (blobparam4.present) {
      map['blobparam4'] = Variable<Uint8List>(blobparam4.value);
    }
    if (blobparam5.present) {
      map['blobparam5'] = Variable<Uint8List>(blobparam5.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<int>(createdAt.value);
    }
...
class $$IdentityTableFilterComposer
  ...
  ColumnFilters<int> get saltVersion => $composableBuilder(
    column: $table.saltVersion,
    builder: (column) => ColumnFilters(column),
  );
...
class $$IdentityTableOrderingComposer
  ...
  ColumnOrderings<int> get saltVersion => $composableBuilder(
    column: $table.saltVersion,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$IdentityTableAnnotationComposer
  ...
  GeneratedColumn<int> get saltVersion => $composableBuilder(
    column: $table.saltVersion,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String?> bio = const Value.absent(),
                Value<String?> phoneNumber = const Value.absent(),
                Value<int> saltVersion = const Value.absent(),
...
class $$MessagesTableFilterComposer
  ...
  ColumnFilters<String> get decryptedMessage => $composableBuilder(
    column: $table.decryptedMessage,
    builder: (column) => ColumnFilters(column),
  );
...
class $$MessagesTableOrderingComposer
  ...
  ColumnOrderings<String> get decryptedMessage => $composableBuilder(
    column: $table.decryptedMessage,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$MessagesTableAnnotationComposer
  ...
  GeneratedColumn<String> get decryptedMessage => $composableBuilder(
    column: $table.decryptedMessage,
    builder: (column) => column,
  );
...
class $$GroupsTableFilterComposer
  ...
  ColumnFilters<String> get newPrivateKey => $composableBuilder(
    column: $table.newPrivateKey,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<int> get swapTime => $composableBuilder(
    column: $table.swapTime,
    builder: (column) => ColumnFilters(column),
  );
...
class $$GroupsTableOrderingComposer
  ...
  ColumnOrderings<String> get newPrivateKey => $composableBuilder(
    column: $table.newPrivateKey,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<int> get swapTime => $composableBuilder(
    column: $table.swapTime,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$GroupsTableAnnotationComposer
  ...
  GeneratedColumn<String> get newPrivateKey => $composableBuilder(
    column: $table.newPrivateKey,
    builder: (column) => column,
  );

  GeneratedColumn<int> get swapTime =>
      $composableBuilder(column: $table.swapTime, builder: (column) => column);
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  ColumnFilters<Uint8List> get blobparam1 => $composableBuilder(
    column: $table.blobparam1,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<Uint8List> get blobparam2 => $composableBuilder(
    column: $table.blobparam2,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<Uint8List> get blobparam3 => $composableBuilder(
    column: $table.blobparam3,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<Uint8List> get blobparam4 => $composableBuilder(
    column: $table.blobparam4,
    builder: (column) => ColumnFilters(column),
  );

  ColumnFilters<Uint8List> get blobparam5 => $composableBuilder(
    column: $table.blobparam5,
    builder: (column) => ColumnFilters(column),
  );
...
class $$TasksTableOrderingComposer
  ...
  ColumnOrderings<Uint8List> get blobparam1 => $composableBuilder(
    column: $table.blobparam1,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<Uint8List> get blobparam2 => $composableBuilder(
    column: $table.blobparam2,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<Uint8List> get blobparam3 => $composableBuilder(
    column: $table.blobparam3,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<Uint8List> get blobparam4 => $composableBuilder(
    column: $table.blobparam4,
    builder: (column) => ColumnOrderings(column),
  );

  ColumnOrderings<Uint8List> get blobparam5 => $composableBuilder(
    column: $table.blobparam5,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TasksTableAnnotationComposer
  ...
  GeneratedColumn<Uint8List> get blobparam1 => $composableBuilder(
    column: $table.blobparam1,
    builder: (column) => column,
  );

  GeneratedColumn<Uint8List> get blobparam2 => $composableBuilder(
    column: $table.blobparam2,
    builder: (column) => column,
  );

  GeneratedColumn<Uint8List> get blobparam3 => $composableBuilder(
    column: $table.blobparam3,
    builder: (column) => column,
  );

  GeneratedColumn<Uint8List> get blobparam4 => $composableBuilder(
    column: $table.blobparam4,
    builder: (column) => column,
  );

  GeneratedColumn<Uint8List> get blobparam5 => $composableBuilder(
    column: $table.blobparam5,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                blobparam1: blobparam1,
                blobparam2: blobparam2,
                blobparam3: blobparam3,
                blobparam4: blobparam4,
                blobparam5: blobparam5,
                createdAt: createdAt,
                updatedAt: updatedAt,
